...
impl Certificate {
    ...
    pub fn set_subject(&mut self, components: &[SubjectComponent]) -> Result<(), MlsCryptoError> {
        unsafe {
    ...
    pub fn subject_bytes(&self) -> Result<Vec<u8>, MlsCryptoError> {
        unsafe {
    ...
    pub fn subject_components(&self) -> Result<Vec<SubjectComponent>, MlsCryptoError> {
        unsafe {
            let name = check_non_null(X509_get_subject_name(self.0))?;
    ...
    pub fn add_extension(&mut self, ext: &X509Extension) -> Result<(), MlsCryptoError> {
        unsafe { check_res(X509_add_ext(self.0, ext.0, -1)) }
    }

    pub fn extensions(&self) -> Result<Vec<X509Extension>, MlsCryptoError> {
        unsafe {
    ...
    pub fn issuer(&self) -> Result<Vec<SubjectComponent>, MlsCryptoError> {
        unsafe {
    ...
    pub fn set_issuer(&mut self, issuer: &[SubjectComponent]) -> Result<(), MlsCryptoError> {
        unsafe {
    ...
    pub fn not_before(&self) -> Result<MlsTime, MlsCryptoError> {
        unsafe {
    ...
    pub fn not_after(&self) -> Result<MlsTime, MlsCryptoError> {
        unsafe {
    ...
    pub fn set_not_before(&mut self, not_before: MlsTime) -> Result<(), MlsCryptoError> {
        unsafe {
    ...
    pub fn set_not_after(&mut self, not_after: MlsTime) -> Result<(), MlsCryptoError> {
        unsafe {
    ...
    pub fn serial_number(&self) -> Result<Vec<u8>, MlsCryptoError> {
        unsafe {
    ...
    pub fn set_serial_number(&self, number: &[u8]) -> Result<(), MlsCryptoError> {
        unsafe {
    ...
    pub fn public_key(&self) -> Result<SignaturePublicKey, MlsCryptoError> {
        unsafe {
    ...
    pub fn subject_alt_names(&self) -> Result<Vec<SubjectAltName>, MlsCryptoError> {
        unsafe {
    ...
    pub fn to_der(&self) -> Result<DerCertificate, MlsCryptoError> {
        unsafe {
...
unsafe fn asn1_time_to_posix(time: *const ASN1_TIME) -> Result<MlsTime, MlsCryptoError> {
    let mut out = 0i64;
...
unsafe fn posix_to_asn1_time(time: MlsTime) -> Result<*mut ASN1_TIME, MlsCryptoError> {
