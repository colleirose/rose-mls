...
The point here is that we want to have simple code, limit dependencies and improve performance as much as possible while having secure support for all ciphersuites. We also want to support as many devices as possible while still maintaining security.
